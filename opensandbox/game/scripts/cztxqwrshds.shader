...
{
	{
		map models/weapons2/plasma/cztxpg_glw.jpg
...
models/weapons2/railgun/cztxfrg
{
	...
	sort additive
	{
		map models/weapons2/railgun/frg.jpg
		tcMod rotate 420
		blendfunc add
	}
}
...
{
	{
		map models/weapons2/railgun/cztxrggw3.jpg
...
{
	{
		map models/weapons2/lightning/cztxltghb1.jpg
		rgbGen lightingDiffuse
	}
	{
		map models/weapons2/lightning/cztxltghb2.jpg
...
{
	{
		map models/weapons2/lightning/cztxltgcr1.jpg
		rgbGen lightingDiffuse
	}
	{
		map models/weapons2/lightning/cztxltgcr2.jpg
...
{
	{
		...
		tcMod scroll 4.0 0.2
		tcmod scale 2.0 2.0
	}
	{
		map models/weapons2/lightning/lgg2.jpg
	...
	{
		map models/weapons2/lightning/cztxltgdt2.jpg
