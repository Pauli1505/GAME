...
void CG_TestModel_f (void) {
	...
	cg.testModelEntity.hModel = trap_R_RegisterModel_engine( cg.testModelName );
...
static void CG_ViewFog( void ) {
	...
	cg.viewfog[0].hModel = trap_R_RegisterModel_engine( va("models/fog%i", mod_fogModel) );
...
static void CG_ViewSky( void ) {
	...
	cg.viewsky.hModel = trap_R_RegisterModel_engine( "models/fog1" );
