...
skill 1
{
	CHARACTERISTIC_NAME							"NPC"
	CHARACTERISTIC_GENDER						"Neutral"
	CHARACTERISTIC_ATTACK_SKILL					0.250
	CHARACTERISTIC_WEAPONWEIGHTS				"bots/npc_w.c"
	...
	CHARACTERISTIC_CHAT_FILE					"bots/npc_t.c"
	CHARACTERISTIC_CHAT_NAME					"npc"
	...
	CHARACTERISTIC_ITEMWEIGHTS					"bots/npc_i.c"
	CHARACTERISTIC_AGGRESSION					3.000
