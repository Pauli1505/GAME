...
ui_icons/iconw_pistol
{
	nopicmip // NOPICNIC
	{
		map icons/iconw_pistol.tga
		blendFunc blend
		rgbgen vertex
	}
}
ui_icons/iconw_machinegun
{
	nopicmip
	{
...
// ammo icons
//
ui_icons/icona_pistol
{
	nopicmip // NOPICNIC ?
	{
		map icons/icona_pistol.tga
		blendFunc blend
		rgbgen vertex
	}
}
ui_icons/icona_machinegun
{
	nopicmip
	{
