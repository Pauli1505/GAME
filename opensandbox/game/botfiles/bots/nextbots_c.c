...
skill 1
{
	CHARACTERISTIC_NAME							"Nextbot"
	CHARACTERISTIC_GENDER						"Female"
	CHARACTERISTIC_ATTACK_SKILL					0.250
	CHARACTERISTIC_WEAPONWEIGHTS				"bots/nextbots_w.c"
	...
	CHARACTERISTIC_CHAT_FILE					"bots/nextbots_t.c"
	CHARACTERISTIC_CHAT_NAME					"nextbot"
	...
	CHARACTERISTIC_ITEMWEIGHTS					"bots/nextbots_i.c"
