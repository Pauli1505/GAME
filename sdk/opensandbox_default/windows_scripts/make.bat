...
copy sdk\opensandbox_default\windows\game\qvm\qagame.qvm game\game\core.default\qvm\qagame.qvm
copy sdk\opensandbox_default\windows\game\qvm\cgame.qvm game\game\core.default\qvm\cgame.qvm
copy sdk\opensandbox_default\windows\game\qvm\ui.qvm game\game\core.default\qvm\ui.qvm
