...
float	pm_airaccelerate = 10.0f;
float	pm_veh00001accelerate = 15.0f*0.090; //VEHICLE-SYSTEM: accelerate control
float	pm_wateraccelerate = 4.0f;
float	pm_flyaccelerate = 10.0f;
float	pm_ladderAccelerate = 50;

float	pm_friction = 3.0f;
