...
# build number starts from 16.02.2025

echo "---------------------------------------"
echo "QYTRINE QVM COMPILESCRIPT"
...
cc="./lcc -w -DQAGAME -DQ3_VM -S -Wf-target=bytecode -Wf-g -I../../../code/game -I/usr/include/ -I../../../code/qcommon $1"
...
cp ../../../code/game/g_syscalls.asm .. # god why do we need to make everything assembly manually before assembling it into bytecode?
...
cc="./lcc -w -DCGAME -DQ3_VM -S -Wf-target=bytecode -Wf-g -I..\..\..\code\cgame -I..\..\..\code\ui -I..\..\..\code\qcommon $1" # no idea if linking is supported on lcc
# but i wouldnt try linking because god knows where its linking dir is
...
$cc -DBUILD_NUMBER=$BUILD_NUMBER ../../../code/ui/ui_menu.c
...
# moved this so that incase it fails it doesnt count as a valid build numb

# build number starts from 16.02.2025

BUILD_FILE="build_number.txt"

#read the current build numb
...
cp sdk/opensandbox_default/linux/game/qvm/qagame.qvm game/game/core.default/qvm/
cp sdk/opensandbox_default/linux/game/qvm/cgame.qvm game/game/core.default/qvm/
cp sdk/opensandbox_default/linux/game/qvm/ui.qvm game/game/core.default/qvm/
