...
itemnode_t server_itemlist[ITEM_COUNT] = {
	...
	{ ITEMGROUP_WEAPON, ITEM_ANTIMATTER, 		"weapon_pistol", 			"pt"},
...
// i dont give a shit
// why does the compiler keep bitching abt too many initializers?
...
// On startup we load from engineui.dat, check for new vars from this list,
