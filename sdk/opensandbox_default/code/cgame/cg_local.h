...
sfxHandle_t	trap_S_RegisterSound_engine( const char *sample, qboolean compressed );		// returns buzz if not found
...
qhandle_t	trap_R_RegisterModel_engine( const char *name );			// returns rgb axis if not found
