...
// Copyright (C) 2025 Qytrine team
// 
// This file is part of Qytrine
// 
// Qytrine is free software; you can redistribute, read/modify
...
// 
// Contact: paulthedev1505@gmail.com
// 
/*
=======================================================================
...
// basic commands:
// trap_System -- execute a system command (using shell, on windows its cmd and on unix its bash)
// trap_Cmd_ExecuteText -- execute a command using the ingame cvar console
// trap_cvar_set -- simply set a cvar.
...
void MainMenu_ReloadGame( void )
{
	...
	UI_ConfirmMenu( "?", 0, MainMenu_ReloadAction );
	}
}
...
why is there a comment on ttimo
===============
*/

#define COMPILETIME (__COUNTER__ + 1)
...
static void Main_MenuDraw( void ) {
    ...
    if (strlen(s_errorMessage.errorMessage)) {
        ...
        UI_DrawString(218 - uis.wideoffset, 195, "engine build 2025.2", UI_RIGHT | UI_SMALLFONT, color);
        UI_DrawString(218 - uis.wideoffset, 110, "Gamebuild:", UI_RIGHT | UI_SMALLFONT, color);
		UI_DrawString(218 - uis.wideoffset, 125, "16.02.2025", UI_RIGHT | UI_SMALLFONT, color); // DD/MM/YY fuck americas MM/DD/YY format
    }
}
...
void UI_MainMenu( void ) {
	...
	if(cl_language.integer == 1){
    s_main.singleplayer.string			= "Start";
	if(!ui_singlemode.integer){
    s_main.multiplayer.string			= "Multiplayer";
	} else {
	s_main.multiplayer.string			= "Savegame";
	}
    s_main.gamemodep.string			    = "Workshop";
	s_main.name.string					= "Profile";
    s_main.mods.string			    	= "Mods";
