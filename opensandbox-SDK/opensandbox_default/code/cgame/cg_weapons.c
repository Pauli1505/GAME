...
static void CG_PistolEjectBrass( centity_t *cent ) {
	...
	velocity[0] = 0;
	velocity[1] = -25 + 20 * crandom();
	velocity[2] = 75 + 25 * crandom();
...
void CG_RegisterWeapon( int weaponNum ) {
	...
	case WP_PISTOL:
		MAKERGB( weaponInfo->flashDlightColor, 1, 1, 0); // this literally just does the flashlight color lmao
		weaponInfo->flashSound[0] = trap_S_RegisterSound_SourceTech( "sound/weapons/pistol/shoot.ogg", qfalse);
