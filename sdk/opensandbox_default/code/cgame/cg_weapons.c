...
static void CG_PistolEjectBrass( centity_t *cent ) {
	...
	velocity[0] = 0;
	velocity[1] = -30 + 20 * crandom(); // this is just CG_MachineGunEjectBrass but the velocity adjusted for more realism because im so lazy
	velocity[2] = 60 + 30 * crandom(); // i shouldve just lowkey used CG_MachineGunEjectBrass directly
...
void CG_RegisterWeapon( int weaponNum ) {
	...
	weaponInfo->weaponModel = trap_R_RegisterModel_engine( item->world_model[0] );
	...
	if ( ammo->classname && ammo->world_model[0] ) {
		weaponInfo->ammoModel = trap_R_RegisterModel_engine( ammo->world_model[0] );
	}

	Q_strncpyz( path, item->world_model[0], MAX_QPATH );
	COM_StripExtension(path, path, sizeof(path));
	strcat( path, "_flash.md3" );
	weaponInfo->flashModel = trap_R_RegisterModel_engine( path );

	Q_strncpyz( path, item->world_model[0], MAX_QPATH );
	COM_StripExtension(path, path, sizeof(path));
	strcat( path, "_barrel.md3" );
	weaponInfo->barrelModel = trap_R_RegisterModel_engine( path );

	Q_strncpyz( path, item->world_model[0], MAX_QPATH );
	COM_StripExtension(path, path, sizeof(path));
	strcat( path, "_hand.md3" );
	weaponInfo->handsModel = trap_R_RegisterModel_engine( path );

	if ( !weaponInfo->handsModel ) {
		weaponInfo->handsModel = trap_R_RegisterModel_engine( "models/weapons2/shotgun/shotgun_hand.md3" );
	}
	...
	case WP_GAUNTLET:
		...
		//weaponInfo->readySound = trap_S_RegisterSound_engine( "sound/weapons/bfg/bfg_humd.wav", qfalse );
		weaponInfo->firingSound = trap_S_RegisterSound_engine( "sound/weapons/melee/fstrun.wav", qfalse );
		weaponInfo->flashSound[0] = trap_S_RegisterSound_engine( "sound/weapons/melee/fstatck.wav", qfalse );
		break;

	case WP_LIGHTNING:
		MAKERGB( weaponInfo->flashDlightColor, 0.6f, 0.6f, 1.0f );
		weaponInfo->readySound = trap_S_RegisterSound_engine( "sound/weapons/melee/fsthum.wav", qfalse );
		weaponInfo->firingSound = trap_S_RegisterSound_engine( "sound/weapons/lightning/lg_hum.wav", qfalse );

		weaponInfo->flashSound[0] = trap_S_RegisterSound_engine( "sound/weapons/lightning/lg_fire.wav", qfalse );
		cgs.media.lightningShader = trap_R_RegisterShader( "lightningBoltNew");
		cgs.media.lightningExplosionModel = trap_R_RegisterModel_engine( "models/weaphits/crackle.md3" );
		cgs.media.sfx_lghit1 = trap_S_RegisterSound_engine( "sound/weapons/lightning/lg_hit.wav", qfalse );
		cgs.media.sfx_lghit2 = trap_S_RegisterSound_engine( "sound/weapons/lightning/lg_hit2.wav", qfalse );
		cgs.media.sfx_lghit3 = trap_S_RegisterSound_engine( "sound/weapons/lightning/lg_hit3.wav", qfalse );

		break;

	case WP_GRAPPLING_HOOK:
		MAKERGB( weaponInfo->flashDlightColor, 0.6f, 0.6f, 1.0f );
		weaponInfo->missileModel = trap_R_RegisterModel_engine( "models/ammo/hook/hook.md3" );
		...
		weaponInfo->flashSound[0] = trap_S_RegisterSound_engine( "sound/weapons/grapple/grapfire.wav", qfalse );
		weaponInfo->missileSound = trap_S_RegisterSound_engine( "sound/weapons/grapple/grappull.wav", qfalse );
        //cgs.media.lightningShader = trap_R_RegisterShader( "lightningBoltNew");
		break;


	case WP_CHAINGUN:
		weaponInfo->firingSound = trap_S_RegisterSound_engine( "sound/weapons/vulcan/wvulfire.wav", qfalse );
		weaponInfo->loopFireSound = qtrue;
		MAKERGB( weaponInfo->flashDlightColor, 1, 1, 0 );
		weaponInfo->flashSound[0] = trap_S_RegisterSound_engine( "sound/weapons/vulcan/vulcanf1b.wav", qfalse );
		weaponInfo->flashSound[1] = trap_S_RegisterSound_engine( "sound/weapons/vulcan/vulcanf2b.wav", qfalse );
		weaponInfo->flashSound[2] = trap_S_RegisterSound_engine( "sound/weapons/vulcan/vulcanf3b.wav", qfalse );
		weaponInfo->flashSound[3] = trap_S_RegisterSound_engine( "sound/weapons/vulcan/vulcanf4b.wav", qfalse );
	...
	case WP_PISTOL:
		MAKERGB( weaponInfo->flashDlightColor, 1, 1, 0);
		weaponInfo->flashSound[0] = trap_S_RegisterSound_engine( "sound/weapons/pistol/fire.wav", qfalse);
	...
	case WP_MACHINEGUN:
		MAKERGB( weaponInfo->flashDlightColor, 1, 1, 0 );
		weaponInfo->flashSound[0] = trap_S_RegisterSound_engine( "sound/weapons/machinegun/ric1.wav", qfalse );
		weaponInfo->flashSound[1] = trap_S_RegisterSound_engine( "sound/weapons/machinegun/ric2.wav", qfalse );
		weaponInfo->flashSound[2] = trap_S_RegisterSound_engine( "sound/weapons/machinegun/ric3.wav", qfalse );
		weaponInfo->flashSound[3] = trap_S_RegisterSound_engine( "sound/weapons/machinegun/machgf4b.wav", qfalse );
		weaponInfo->ejectBrassFunc = CG_MachineGunEjectBrass;
		cgs.media.bulletExplosionShader = trap_R_RegisterShader( "bulletExplosion" );
		break;
	...
	case WP_SHOTGUN:
		MAKERGB( weaponInfo->flashDlightColor, 1, 1, 0 );
		weaponInfo->flashSound[0] = trap_S_RegisterSound_engine( "sound/weapons/shotgun/sshotf1b.wav", qfalse );
		weaponInfo->ejectBrassFunc = CG_ShotgunEjectBrass;
		break;

	case WP_ROCKET_LAUNCHER:
		weaponInfo->missileModel = trap_R_RegisterModel_engine( "models/ammo/rocket/rocket.md3" );
		weaponInfo->missileSound = trap_S_RegisterSound_engine( "sound/weapons/rocket/rockfly.wav", qfalse );
		...
		weaponInfo->flashSound[0] = trap_S_RegisterSound_engine( "sound/weapons/rocket/rocklf1a.wav", qfalse );
		cgs.media.rocketExplosionShader = trap_R_RegisterShader( "rocketExplosion" );
		break;

	case WP_PROX_LAUNCHER:
		weaponInfo->missileModel = trap_R_RegisterModel_engine( "models/weaphits/proxmine.md3" );
		weaponInfo->missileTrailFunc = CG_GrenadeTrail;
		weaponInfo->wiTrailTime = 700;
		weaponInfo->trailRadius = 32;
		MAKERGB( weaponInfo->flashDlightColor, 1, 0.70f, 0 );
		weaponInfo->flashSound[0] = trap_S_RegisterSound_engine( "sound/weapons/proxmine/wstbfire.wav", qfalse );
		cgs.media.grenadeExplosionShader = trap_R_RegisterShader( "grenadeExplosion" );
		break;

	case WP_GRENADE_LAUNCHER:
		weaponInfo->missileModel = trap_R_RegisterModel_engine( "models/ammo/grenade1.md3" );
		weaponInfo->missileTrailFunc = CG_GrenadeTrail;
		weaponInfo->wiTrailTime = 700;
		weaponInfo->trailRadius = 32;
		MAKERGB( weaponInfo->flashDlightColor, 1, 0.70f, 0 );
		weaponInfo->flashSound[0] = trap_S_RegisterSound_engine( "sound/weapons/grenade/grenlf1a.wav", qfalse );
		cgs.media.grenadeExplosionShader = trap_R_RegisterShader( "grenadeExplosion" );
		break;
...
//		weaponInfo->missileSound = trap_S_RegisterSound_engine( "sound/weapons/nailgun/wnalflit.wav", qfalse );
		weaponInfo->trailRadius = 16;
		weaponInfo->wiTrailTime = 250;
		weaponInfo->missileModel = trap_R_RegisterModel_engine( "models/weaphits/nail.md3" );
		MAKERGB( weaponInfo->flashDlightColor, 1, 0.75f, 0 );
		weaponInfo->flashSound[0] = trap_S_RegisterSound_engine( "sound/weapons/nailgun/wnalfire.wav", qfalse );
		break;
...
//		weaponInfo->missileModel = cgs.media.invulnerabilityPowerupModel;
		...
		weaponInfo->missileSound = trap_S_RegisterSound_engine( "sound/weapons/plasma/lasfly.wav", qfalse );
		MAKERGB( weaponInfo->flashDlightColor, 0.6f, 0.6f, 1.0f );
		weaponInfo->flashSound[0] = trap_S_RegisterSound_engine( "sound/weapons/plasma/hyprbf1a.wav", qfalse );
		cgs.media.plasmaExplosionShader = trap_R_RegisterShader( "plasmaExplosion" );
		cgs.media.railRingsShader = trap_R_RegisterShader( "railDisc" );
		break;

	case WP_RAILGUN:
		weaponInfo->readySound = trap_S_RegisterSound_engine( "sound/weapons/railgun/rg_hum.wav", qfalse );
		MAKERGB( weaponInfo->flashDlightColor, 1, 0.5f, 0 );
		weaponInfo->flashSound[0] = trap_S_RegisterSound_engine( "sound/weapons/railgun/railgf1a.wav", qfalse );
	...
	case WP_BFG:
		weaponInfo->readySound = trap_S_RegisterSound_engine( "sound/weapons/bfg/bfg_hum.wav", qfalse );
		MAKERGB( weaponInfo->flashDlightColor, 1, 0.7f, 1 );
		MAKERGB( weaponInfo->missileDlightColor, 0.40f, 1, 0.20f );
		weaponInfo->missileDlight = 200;
		weaponInfo->flashSound[0] = trap_S_RegisterSound_engine( "sound/weapons/bfg/bfg_fire.wav", qfalse );
		cgs.media.bfgExplosionShader = trap_R_RegisterShader( "bfgExplosion" );
		weaponInfo->missileModel = trap_R_RegisterModel_engine( "models/weaphits/bfg.md3" );
		weaponInfo->missileSound = trap_S_RegisterSound_engine( "sound/weapons/rocket/rockfly.wav", qfalse );
		break;
		
	case WP_FLAMETHROWER:
//		weaponInfo->missileModel = cgs.media.invulnerabilityPowerupModel;
		weaponInfo->missileSound = trap_S_RegisterSound_engine( "sound/weapons/flamethrower/lasfly.wav", qfalse );
		MAKERGB( weaponInfo->flashDlightColor, 1.0f, 1.0f, 1.0f );
		weaponInfo->flashSound[0] = trap_S_RegisterSound_engine( "sound/weapons/flamethrower/hyprbf1a.wav", qfalse );
		cgs.media.plasmaExplosionShader = trap_R_RegisterShader( "plasmaExplosion" );
		cgs.media.railRingsShader = trap_R_RegisterShader( "railDisc" );
		break;
	...
	case WP_ANTIMATTER:
//		weaponInfo->missileModel = cgs.media.invulnerabilityPowerupModel;
		weaponInfo->missileSound = trap_S_RegisterSound_engine( "sound/weapons/antimatter/lasfly.wav", qfalse );
		MAKERGB( weaponInfo->flashDlightColor, 1.0f, 1.0f, 1.0f );
		weaponInfo->flashSound[0] = trap_S_RegisterSound_engine( "sound/weapons/antimatter/hyprbf1a.wav", qfalse );
		cgs.media.plasmaExplosionShader = trap_R_RegisterShader( "plasmaExplosion" );
		cgs.media.railRingsShader = trap_R_RegisterShader( "railDisc" );
		break;
	...
	case WP_TOOLGUN:
		...
		//weaponInfo->missileSound = trap_S_RegisterSound_engine( "sound/weapons/antimatter/lasfly.wav", qfalse );
		//MAKERGB( weaponInfo->flashDlightColor, 1.0f, 1.0f, 1.0f );
		weaponInfo->flashSound[0] = trap_S_RegisterSound_engine( "sound/weapons/toolgun/fire1.wav", qfalse );
		weaponInfo->flashSound[1] = trap_S_RegisterSound_engine( "sound/weapons/toolgun/fire2.wav", qfalse );
		cgs.media.plasmaExplosionShader = trap_R_RegisterShader( "plasmaExplosion" );
		cgs.media.lightningShader = trap_R_RegisterShader( "lightningBoltNew");
		//cgs.media.railRingsShader = trap_R_RegisterShader( "railDisc" );
		break;
	...
	case WP_PHYSGUN:
		weaponInfo->flashSound[0] = trap_S_RegisterSound_engine( "sound/misc/silence.wav", qfalse );
		cgs.media.plasmaExplosionShader = trap_R_RegisterShader( "plasmaExplosion" );
		cgs.media.lightningShader = trap_R_RegisterShader( "lightningBoltNew");
		break;
	...
	case WP_THROWER:
		MAKERGB( weaponInfo->flashDlightColor, 1, 1, 0 );
		weaponInfo->flashSound[0] = trap_S_RegisterSound_engine( "sound/weapons3/machinegun/machgf1b.wav", qfalse );
		weaponInfo->flashSound[1] = trap_S_RegisterSound_engine( "sound/weapons3/machinegun/machgf2b.wav", qfalse );
		weaponInfo->flashSound[2] = trap_S_RegisterSound_engine( "sound/weapons3/machinegun/machgf3b.wav", qfalse );
		weaponInfo->flashSound[3] = trap_S_RegisterSound_engine( "sound/weapons3/machinegun/machgf4b.wav", qfalse );
		weaponInfo->ejectBrassFunc = CG_MachineGunEjectBrass;
		break;

	case WP_BOUNCER:
		MAKERGB( weaponInfo->flashDlightColor, 1, 1, 0 );
		weaponInfo->flashSound[0] = trap_S_RegisterSound_engine( "sound/weapons3/shotgun/sshotf1b.wav", qfalse );
		weaponInfo->ejectBrassFunc = CG_ShotgunEjectBrass;
		break;

	case WP_THUNDER:
		MAKERGB( weaponInfo->flashDlightColor, 1, 0.70f, 0 );
		weaponInfo->flashSound[0] = trap_S_RegisterSound_engine( "sound/weapons3/grenade/grenlf1a.wav", qfalse );
		break;

	case WP_EXPLODER:
		weaponInfo->missileModel = trap_R_RegisterModel_engine( "models/ammo/rocket/rocket.md3" );
		weaponInfo->missileSound = trap_S_RegisterSound_engine( "sound/weapons3/rocket/rockfly.wav", qfalse );
		weaponInfo->missileTrailFunc = CG_RocketTrail;
		weaponInfo->missileDlight = 200;
		weaponInfo->wiTrailTime = 2000;
		weaponInfo->trailRadius = 64;
		...
		weaponInfo->flashSound[0] = trap_S_RegisterSound_engine( "sound/weapons3/rocket/rocklf1a.wav", qfalse );
		cgs.media.rocketExplosionShader = trap_R_RegisterShader( "rocketExplosion" );
		break;

	case WP_KNOCKER:
		MAKERGB( weaponInfo->flashDlightColor, 0.6f, 0.6f, 1.0f );
		weaponInfo->readySound = trap_S_RegisterSound_engine( "sound/weapons3/melee/fsthum.wav", qfalse );
		weaponInfo->firingSound = trap_S_RegisterSound_engine( "sound/weapons3/lightning/lg_hum.wav", qfalse );

		weaponInfo->flashSound[0] = trap_S_RegisterSound_engine( "sound/weapons3/lightning/lg_fire.wav", qfalse );
		cgs.media.lightningShader = trap_R_RegisterShader( "lightningBoltNew");
		cgs.media.lightningExplosionModel = trap_R_RegisterModel_engine( "models/weaphits/crackle.md3" );
		cgs.media.sfx_lghit1 = trap_S_RegisterSound_engine( "sound/weapons3/lightning/lg_hit.wav", qfalse );
		cgs.media.sfx_lghit2 = trap_S_RegisterSound_engine( "sound/weapons3/lightning/lg_hit2.wav", qfalse );
		cgs.media.sfx_lghit3 = trap_S_RegisterSound_engine( "sound/weapons3/lightning/lg_hit3.wav", qfalse );
		break;

	case WP_PROPGUN:
		MAKERGB( weaponInfo->flashDlightColor, 1.0f, 1.0f, 1.0f );
		weaponInfo->flashSound[0] = trap_S_RegisterSound_engine( "sound/weapons3/railgun/railgf1a.wav", qfalse );
		break;
...
void CG_RegisterItemVisuals( int itemNum ) {
	...
	itemInfo->models[0] = trap_R_RegisterModel_engine( item->world_model[0] );
	...
	if ( item->giType == IT_POWERUP || item->giType == IT_HEALTH || 
		...
		if ( item->world_model[1] ) {
			itemInfo->models[1] = trap_R_RegisterModel_engine( item->world_model[1] );
		}
	}
}
...
static float	CG_MachinegunSpinAngle( centity_t *cent ) {
	...
	if ( cent->pe.barrelSpinning == !(cent->currentState.eFlags & EF_FIRING) ) {
		...
		if ( weaphack == WP_CHAINGUN && !cent->pe.barrelSpinning ) {
			trap_S_StartSound( NULL, cent->currentState.number, CHAN_WEAPON, trap_S_RegisterSound_engine( "sound/weapons/vulcan/wvulwind.wav", qfalse ) );
		}
