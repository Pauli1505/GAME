...
static void CG_General( centity_t *cent ) {
	...
	wheelfr.hModel = trap_R_RegisterModel_engine( "models/v_wheel" );
	...
	wheelfl.hModel = trap_R_RegisterModel_engine( "models/v_wheel" );
	...
	wheelrr.hModel = trap_R_RegisterModel_engine( "models/v_wheel" );
	...
	wheelrl.hModel = trap_R_RegisterModel_engine( "models/v_wheel" );
